...
Check the [Releases page](https://github.com/bizshuk/yfin/releases) for:
...
go get github.com/bizshuk/yfin@latest
```
...
curl -L "https://github.com/bizshuk/yfin/releases/download/v1.0.0/yfin_linux_amd64.tar.gz" | tar xz
