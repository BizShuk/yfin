...
Check the [Releases page](https://github.com/bizshuk/yfinance-go/releases) for:
...
go get github.com/bizshuk/yfinance-go@latest
```
...
curl -L "https://github.com/bizshuk/yfinance-go/releases/download/v1.0.0/yfin_linux_amd64.tar.gz" | tar xz
