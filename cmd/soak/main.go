...
func init() {
	...
	rootCmd.Flags().BoolVar(&soakConfig.Preview, "preview", false, "Enable preview mode")
	rootCmd.Flags().BoolVar(&soakConfig.Publish, "publish", false, "Enable publishing to bus")
	rootCmd.Flags().StringVar(&soakConfig.Env, "env", "dev", "Environment for publishing")
	rootCmd.Flags().StringVar(&soakConfig.TopicPrefix, "topic-prefix", "ampy.dev", "Topic prefix for publishing")
